...
function DictQuickLookup:changeDictionary(index, skip_update)
    ...
    -- Wrapped in pcall so a word with unusual characters can't crash the popup.
...
-- Register as the canonical module so any require() elsewhere gets this version
package.loaded["ui/widget/dictquicklookup"] = DictQuickLookup
