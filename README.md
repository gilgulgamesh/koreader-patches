...
notes inside the patch, along with instructions on editing it

# 2-double-progress-bar-transparent.lua
	
Transparent gives a transparent unseen colour. This is useful for 
...
Shows all headings instead of just h1. 

to do (one day): make this into a toggle.  -- currently this works best alongside the original, disabling one or the other
