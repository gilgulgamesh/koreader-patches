...
local light  = Blitbuffer.COLOR_GRAY_D
...
local margin = 0 --BOOK_MARGIN --or any numeric value. Marin from sides
...
local prog_bar_thickness = 8 -- progress bar height.
local bottom_padding = -1 --42 -- space between progress bars and bottom edge. Negative tucks it in
-- "colour" settings        -- you can change the definitions above
local top_bar_seen_color     = black
...
x = top_bar_percentage * prog_bar_width
z = bottom_bar_percentage * prog_bar_width
